...
> 提醒： Heroku 已经封禁本专案，请 Fork 本专案后，将 README.md 中的 ECS-tasy 替换为自己的用户名后，再进行部署。 
...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/ECS-tasy/HerokuXray) 
...
* [CloudflareST](https://github.com/ECS-tasy/CloudflareST) `OpenWrt推荐-速度较快`
* [cf-autoupdate](https://github.com/ECS-tasy/cf-autoupdate) `OpenWrt推荐`
